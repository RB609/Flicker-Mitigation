...
HD_PWD='C:/Users/admin/Desktop/5b6b/Decode_A_2Mbps/hdl_netlist/decode_a.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_a.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decode_a.tcl -notrace
