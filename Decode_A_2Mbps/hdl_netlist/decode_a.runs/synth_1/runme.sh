...
HD_PWD='C:/Users/admin/Desktop/5b6b/Decode_A_2Mbps/hdl_netlist/decode_a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decode_a.tcl
