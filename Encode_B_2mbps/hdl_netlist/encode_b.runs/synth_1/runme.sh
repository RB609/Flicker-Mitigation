...
HD_PWD='C:/Users/admin/Desktop/5b6b/B_2mbps/hdl_netlist/encode_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encode_b.tcl
