...
HD_PWD='C:/Users/admin/Desktop/5b6b/B_2mbps/hdl_netlist/encode_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encode_b.tcl -notrace
