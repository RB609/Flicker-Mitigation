...
HD_PWD='C:/Users/admin/Desktop/5b6b/Encode_A_2Mbps/hdl_netlist/func1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func1.tcl
