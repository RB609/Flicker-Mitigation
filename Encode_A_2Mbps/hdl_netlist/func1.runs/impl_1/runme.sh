...
HD_PWD='C:/Users/admin/Desktop/5b6b/Encode_A_2Mbps/hdl_netlist/func1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log func1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source func1.tcl -notrace
