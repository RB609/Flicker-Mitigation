...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{convert_type.v}}
		{{xlclockdriver_rd.v}}
		{{decode_b_entity_declarations.v}}
		{{decode_b.v}}
		{{decode_b_clock.xdc}}
		{{decode_b.xdc}}
	}
	...
	set TargetDir {C:/Users/admin/Desktop/5b6b/Decode_B_2Mbps}
	set TopLevelModule {decode_b}
	set TopLevelSimulinkHandle 770
	...
	dict set TopLevelPortInterface gateway_in DatFile {decode_b_gateway_in.dat}
	...
	dict set TopLevelPortInterface gateway_in ClockDomain {decode_b}
	...
	dict set TopLevelPortInterface gateway_out DatFile {decode_b_gateway_out.dat}
	dict set TopLevelPortInterface gateway_out IconText {Gateway Out}
	dict set TopLevelPortInterface gateway_out Direction out
	dict set TopLevelPortInterface gateway_out Period 6
	...
	dict set TopLevelPortInterface gateway_out ClockDomain {decode_b}
	...
	dict set TopLevelPortInterface clk ClockDomain {decode_b}
