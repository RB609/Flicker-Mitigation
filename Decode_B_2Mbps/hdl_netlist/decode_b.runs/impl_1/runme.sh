...
HD_PWD='C:/Users/admin/Desktop/5b6b/Decode_B_2Mbps/hdl_netlist/decode_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decode_b.tcl -notrace
