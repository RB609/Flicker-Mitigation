...
HD_PWD='C:/Users/admin/Desktop/5b6b/Decode_B_2Mbps/hdl_netlist/decode_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decode_b.tcl
